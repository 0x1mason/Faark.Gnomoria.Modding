...
using Gemini.Modding.HelperMods;
using Game;
using Game.GUI;
...
namespace Faark.Mods
{
    ...
    public class ShowDeveloperConsole: Mod
    {
        ...
        public override IEnumerable<ModDependency> Dependencies
        {
            get
            {
                yield return ModRightClickMenu.Instance;
            }
        }
        public override void Initialize_PreGeneration()
        {
            ModRightClickMenu.AddItem("Toggle Developer Console", ToggleDeveloperConsole);
            ModRightClickMenu.AddItem("Item spawn menu", ItemSpawnMenu);
