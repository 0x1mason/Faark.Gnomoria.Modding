    ...
    public class GameLauncher
    {
        private class CustomDomainForModRuntime : MarshalByRefObject
        {
            ...
            public void runGame()
            {
                ...
                Environment.SetEnvironmentVariable("PATH", ModManager.GameDirectory.FullName + ";" + Environment.CurrentDirectory + ";" + path);
                base_dir = Environment.CurrentDirectory = ModManager.GameDirectory.FullName;
            ...
            System.Reflection.Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
            {
                ...
                if (trgName.Name == "Gemini.Injector")
                {
