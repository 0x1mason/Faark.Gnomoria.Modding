...
{
    //[Serializable]
    public static class ModdedBinaryBuilder
    {
     //   private ModdingEnvironmentConfiguration config;
        private static GnomoriaExeInjector game_injector;
        private static Injector lib_injector;
        private static IMod[] all_mods_to_process = null;
        private static IMod[] all_possible_dependencies = null;
        private static List<IMod> processedMods = new List<IMod>();//order does matter.
        //private HashSet<IMod> processedMods = new HashSet<IMod>();
        private static HashSet<IMod> currentlyProcessing = new HashSet<IMod>();
        private static void ProcessMod (IMod mod)
        {
        ...
        internal static void Build (IMod[] mods_to_use, IMod[] dependencies_to_use, bool useHiDefProfile)
        {
